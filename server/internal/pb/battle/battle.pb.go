...
// K5（DESIGN_KINGDOM）：一方的王国城防塔加成（服务器建房时从 kingdom_buildings 换算，
// 权威下发整数百分比；两端对称注入 → 同一方三塔在两端逐 bit 相同）。
// 本 message 仅在 battle.proto 内使用（无跨文件引用，避 godobuf 跨文件内联坑）。
type TowerBonus struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	HpPct         int32                  `protobuf:"varint,1,opt,name=hp_pct,json=hpPct,proto3" json:"hp_pct,omitempty"`    // 城墙累计：三塔 HP +N%
	DmgPct        int32                  `protobuf:"varint,2,opt,name=dmg_pct,json=dmgPct,proto3" json:"dmg_pct,omitempty"` // 箭楼累计：三塔攻击 +N%
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TowerBonus) Reset() {
	*x = TowerBonus{}
...
func (x *TowerBonus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TowerBonus) ProtoMessage() {}

func (x *TowerBonus) ProtoReflect() protoreflect.Message {
	mi := &file_battle_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TowerBonus.ProtoReflect.Descriptor instead.
func (*TowerBonus) Descriptor() ([]byte, []int) {
	return file_battle_proto_rawDescGZIP(), []int{2}
}

func (x *TowerBonus) GetHpPct() int32 {
	if x != nil {
		return x.HpPct
	}
	return 0
...
func (x *TowerBonus) GetDmgPct() int32 {
	if x != nil {
		return x.DmgPct
	}
	return 0
...
type JoinRoomResp struct {
	...
	// K5：双方王国城防（缺省/空 = 无加成，向后兼容白板；重连重放同一 resp 自动带上）。
	Side1Towers   *TowerBonus `protobuf:"bytes,11,opt,name=side1_towers,json=side1Towers,proto3" json:"side1_towers,omitempty"`
	Side2Towers   *TowerBonus `protobuf:"bytes,12,opt,name=side2_towers,json=side2Towers,proto3" json:"side2_towers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *JoinRoomResp) GetSide1Towers() *TowerBonus {
	if x != nil {
		return x.Side1Towers
	}
	return nil
}

func (x *JoinRoomResp) GetSide2Towers() *TowerBonus {
	if x != nil {
		return x.Side2Towers
	}
	return nil
}
...
const file_battle_proto_rawDesc = "" +
	...
	"\n" +
	"TowerBonus\x12\x15\n" +
	"\x06hp_pct\x18\x01 \x01(\x05R\x05hpPct\x12\x17\n" +
	"\admg_pct\x18\x02 \x01(\x05R\x06dmgPct\"\xe8\x03\n" +
	...
	" \x03(\v2\x15.game.v4.CardProgressR\rside2Progress\x126\n" +
	"\fside1_towers\x18\v \x01(\v2\x13.game.v4.TowerBonusR\vside1Towers\x126\n" +
	"\fside2_towers\x18\f \x01(\v2\x13.game.v4.TowerBonusR\vside2Towers\"j\n" +
	"\tDeployCmd\x12\x12\n" +
...
var file_battle_proto_goTypes = []any{
	...
	(*TowerBonus)(nil),            // 4: game.v4.TowerBonus
	(*JoinRoomResp)(nil),          // 5: game.v4.JoinRoomResp
	(*DeployCmd)(nil),             // 6: game.v4.DeployCmd
	(*TickBundle)(nil),            // 7: game.v4.TickBundle
	(*StateHashUp)(nil),           // 8: game.v4.StateHashUp
	(*BattleEndReport)(nil),       // 9: game.v4.BattleEndReport
	(*BattleResultPush)(nil),      // 10: game.v4.BattleResultPush
	(*HeartbeatPing)(nil),         // 11: game.v4.HeartbeatPing
	(*HeartbeatPong)(nil),         // 12: game.v4.HeartbeatPong
	(*TickBundle_SideDeploy)(nil), // 13: game.v4.TickBundle.SideDeploy
	(*common.ProfileSummary)(nil), // 14: game.v4.ProfileSummary
}
var file_battle_proto_depIdxs = []int32{
	14, // 0: game.v4.JoinRoomResp.opponent:type_name -> game.v4.ProfileSummary
	...
	4,  // 3: game.v4.JoinRoomResp.side1_towers:type_name -> game.v4.TowerBonus
	4,  // 4: game.v4.JoinRoomResp.side2_towers:type_name -> game.v4.TowerBonus
	13, // 5: game.v4.TickBundle.deploys:type_name -> game.v4.TickBundle.SideDeploy
	0,  // 6: game.v4.BattleResultPush.winner:type_name -> game.v4.BattleResultPush.Winner
	1,  // 7: game.v4.BattleResultPush.reason:type_name -> game.v4.BattleResultPush.Reason
	6,  // 8: game.v4.TickBundle.SideDeploy.deploy:type_name -> game.v4.DeployCmd
