...
> **在线化整线收官（N1~N7 全完成）**。下一站 **V5-S7 UI 整合**（闯关地图/养成/钱包/挂机/战力/deck builder 接已解锁卡，接 EconomyStateCache + economy_client；设计稿已就绪 KAN-58；真人验收）/ **V5-S8 内容铺量 + 平衡**（100 关 + 遭遇模板 + 系数曲线 + probe 平衡）。
